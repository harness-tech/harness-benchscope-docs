...
`~/.benchscope` holds all of your performance artifacts, accuracy evaluations, logs, downloaded datasets, and cached models. Back it up before uninstalling or wiping it — see [Update & Uninstall](/en/docs/install/update-uninstall/).
...
Any change you make in the UI is **persisted automatically to `settings.json`**. See [Settings](/en/docs/tools/settings/) for a full walkthrough of each panel.
...
- [CLI Reference](/en/docs/cli/reference/) — `serve` / `perf` / `eval` subcommands
- [Settings](/en/docs/tools/settings/) — the 7 Settings panels
- [Update & Uninstall](/en/docs/install/update-uninstall/) — migration and cleanup of `~/.benchscope`
