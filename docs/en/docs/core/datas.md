...
- [Configuration](../get-started/configuration.md) — artifact storage directories (`perfs_dir` / `evals_dir`)
- [Performance Testing](performance.md) — how performance artifacts are produced
- [Accuracy Testing](accuracy.md) — how accuracy artifacts are produced
