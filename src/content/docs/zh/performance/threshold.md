...
阈值条件可加**输出吞吐下限**（`--output-threshold`），并要求吞吐不低于某值才算达标，详见 [CLI 参考](/zh/docs/cli/reference/)。
...
- [CLI 参考](/zh/docs/cli/reference/) — 阈值模式专属参数
- [教程：并发压测](/zh/docs/performance/concurrency/) — 手动逐档压测
