...
Sessions are cached under the `sessions` subdirectory of your data root. See [Configuration](/en/docs/install/configuration/) (`sessions_dir`) for the exact location and how to override the data root.

## Related

- [Configuration](/en/docs/install/configuration/) — session storage directory
- [Performance Testing](/en/docs/performance/) — for structured, repeatable load testing
- [Settings](/en/docs/tools/settings/) — providers that drive session requests
